...
\hypertarget{-}{%
\subsection{Στατιστική ανάλυση}\label{-}}

Η ανάλυση θα πραγματοποιηθεί σε περιβάλλον της στατιστικής γλώσσας R (R
Core Team, 2018) με χρήση των πακέτων poppr (Kamvar et al., 2014),
hierfstat (Goudet, 2005), και genepop (Rousset, 2008). Οι βασικές
...
Η εκτίμηση δραστικού μεγέθους πληθυσμού θα πραγματοποιηθεί σύμφωνα με τη
μέθοδο πρυ έχει προταθεί α\ldots{}με το πρόγραμμα N\textsubscript{e}
Estimator (Do et al., 2014),

Επίσης θα υπολογιστεί ο αριθμός των γενοτύπων (multilocus genotypes) που
απαντώνται στον υπό μελέτη καστανεώνα.

adegenet (Jombart, 2008) ,pegas,ape,fangorn

-\textgreater{} M ratio -\textgreater{} υποδεικνύει μείωση μεγέθους
πληθυσμού σε μεγάλα χρονικά διαστήματα (Aleksic and Geburek, 2014)
BOTTLENECK -\textgreater{} πρόσφατες γενετικές στενωπούς (2
...
(Aleksic and Geburek, 2014; Pritchard et al., 2000) MIGRATE MIGRAINE
...
πληθυσμών. Αυτό θα ενισχύσει την προσπάθει προστασία των γενετικών πόρων
του είδους στο ΒΑ Αιγαίο και την ορθολογική διαχείρηση του
πολλαπλασιαστικού υλικού

γενετικός χαρακτηρισμός ποικιλία λεσβου Αγιάσου --\textgreater{} για την
